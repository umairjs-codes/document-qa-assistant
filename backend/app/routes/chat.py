...
async def chat(request: ChatRequest):
    ...
    """
    try:
        # Retrieve document and find relevant chunks
        ...
        return ChatResponse(
            ...
            relevant_chunks=relevant_chunks[:2]  # Show top 2 chunks
        )
...
async def chat_stream(doc_id: str, msg: str):
    ...
    async def generate():
        try:
            # Get context
            relevant_chunks = await doc_service.search_chunks(doc_id, msg, top_k=3)
